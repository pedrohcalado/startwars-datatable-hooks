...
export default function TableBody() {
  const { data, filters: { filterByName, filterByNumericValues, order } } = useContext(StarWarsContext);
  ...
  filteredPlanets = filteredPlanets.sort((a,b) => (order.sort === 'ASC') ?
   a[order.column].localeCompare(b[order.column]) : b[order.column].localeCompare(a[order.column]));
  filteredPlanets = filteredPlanets.sort((a, b) => (order.sort === 'ASC') ?
